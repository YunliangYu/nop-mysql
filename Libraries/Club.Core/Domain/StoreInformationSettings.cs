...
namespace Club.Core.Domain
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by Club" text should be displayed.
        /// Please find more info at http://www.Club.com/copyrightremoval.aspx
        /// </summary>
        public bool HidePoweredBySiteCommerce { get; set; }
