...
namespace Club.Core.Configuration
{
    ...
    public partial class SiteConfig : IConfigurationSectionHandler
    {
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var supportPreviousSitecommerceVersionsNode = section.SelectSingleNode("SupportPreviousSitecommerceVersions");
            config.SupportPreviousSitecommerceVersions = GetBool(supportPreviousSitecommerceVersionsNode, "Enabled");
        ...
        /// <summary>
        /// Indicates whether we should support previous Club versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousSitecommerceVersions { get; private set; }
        ...
        /// <summary>
        /// A list of plugins ignored during Club installation
        /// </summary>
