...
namespace Club.Core.Infrastructure
{
    ...
    public class SiteEngine : IEngine
    {
        ...
        protected virtual void RegisterDependencies(SiteConfig config)
        {
            var builder = new ContainerBuilder();
            
            //dependencies
            var typeFinder = new WebAppTypeFinder();
            builder.RegisterInstance(config).As<SiteConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(SiteConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
