        ...
        public void Execute(bool throwException = false, bool dispose = true, bool ensureRunOnOneWebFarmInstance = true)
        {
            ...
            try
            {
                ...
                if (ensureRunOnOneWebFarmInstance)
                {
                    ...
                    var siteConfig = EngineContext.Current.ContainerManager.Resolve<SiteConfig>("", scope);
                    if (siteConfig.MultipleInstancesEnabled)
                    {
                        ...
                        {
                            if (siteConfig.RedisCachingEnabled)
                            {
                                //get expiration time
