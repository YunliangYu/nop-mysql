...
namespace Club.Services.Logging
{
    /// <summary>
    ...
    public class CustomerActivityService : ICustomerActivityService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ACTIVITYTYPE_ALL_KEY = "Club.activitytype.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ACTIVITYTYPE_PATTERN_KEY = "Club.activitytype.";
