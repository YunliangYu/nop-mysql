...
namespace Club.Services.Shipping
{
    /// <summary>
    /// Shipping service
    /// </summary>
    public partial class ShippingService : IShippingService
    {
        ...
        /// {0} : warehouse ID
        /// </remarks>
        private const string WAREHOUSES_BY_ID_KEY = "Club.warehouse.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string WAREHOUSES_PATTERN_KEY = "Club.warehouse.";
            ...
            int storeId = 0)
        {
            ...
            if (!shippingRateComputationMethods.Any())
                //throw new SiteException("Shipping rate computation method could not be loaded");
                return result;
