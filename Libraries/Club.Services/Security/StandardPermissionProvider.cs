...
namespace Club.Services.Security
{
    /// <summary>
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        //
        public static readonly PermissionRecord ManageDealersBasic = new PermissionRecord { Name = "Admin area. Manage Dealer", SystemName = "ManageDealer", Category = "Dealer" };

        public static readonly PermissionRecord ManageApp = new PermissionRecord { Name = "Admin area. Manage App", SystemName = "ManageApp", Category = "Device" };

        public static readonly PermissionRecord ManageFeedback = new PermissionRecord { Name = "Admin area. Manage Feedback", SystemName = "ManageFeedback", Category = "Common" };
