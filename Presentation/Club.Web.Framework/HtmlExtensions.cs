...
namespace Club.Web.Framework
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseSiteEntityModel
        {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseSiteEntityModel
        {
        ...
        public static string GetSelectedTabName(this HtmlHelper helper)
        {
            ...
            const string dataKey = "club.selected-tab-name";
        ...
        public static MvcHtmlString SiteLabelFor<TModel, TValue>(this HtmlHelper<TModel> helper,
                Expression<Func<TModel, TValue>> expression, bool displayHint = true)
        {
            ...
            if (metadata.AdditionalValues.TryGetValue("SiteResourceDisplayName", out value))
            {
                var resourceDisplayName = value as SiteResourceDisplayName;
        ...
        public static MvcHtmlString SiteEditorFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString SiteDropDownList<TModel>(this HtmlHelper<TModel> helper, string name,
        ...
        public static MvcHtmlString SiteDropDownListFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString SiteTextAreaFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString SiteDisplayFor<TModel, TValue>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TValue>> expression)
        {
        ...
        public static MvcHtmlString SiteDisplay<TModel>(this HtmlHelper<TModel> helper, string expression)
        {
            var result = new TagBuilder("div");
            result.Attributes.Add("class", "form-text-row");
