...
{
    public partial class ProductReviewOverviewModel : BaseSiteModel
    {
    ...
    public partial class ProductReviewsModel : BaseSiteModel
    {
    ...
    public partial class ProductReviewHelpfulnessModel : BaseSiteModel
    {
    ...
    public partial class AddProductReviewModel : BaseSiteModel
    {
        [AllowHtml]
        [SiteResourceDisplayName("Reviews.Fields.Title")]
        public string Title { get; set; }

        [AllowHtml]
        [SiteResourceDisplayName("Reviews.Fields.ReviewText")]
        public string ReviewText { get; set; }

        [SiteResourceDisplayName("Reviews.Fields.Rating")]
        public int Rating { get; set; }
