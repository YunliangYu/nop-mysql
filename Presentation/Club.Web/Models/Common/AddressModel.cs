...
namespace Club.Web.Models.Common
{
    ...
    public partial class AddressModel : BaseSiteEntityModel
    {
        ...
        [SiteResourceDisplayName("Address.Fields.FirstName")]
        [AllowHtml]
        public string FirstName { get; set; }
        [SiteResourceDisplayName("Address.Fields.LastName")]
        [AllowHtml]
        public string LastName { get; set; }
        [SiteResourceDisplayName("Address.Fields.Email")]
        [AllowHtml]
        ...
        [SiteResourceDisplayName("Address.Fields.Company")]
        [AllowHtml]
