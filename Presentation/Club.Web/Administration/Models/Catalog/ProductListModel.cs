...
{
    public partial class ProductListModel : BaseSiteModel
    {
        ...
        [SiteResourceDisplayName("Admin.Catalog.Products.List.SearchIncludeSubCategories")]
        ...
        [SiteResourceDisplayName("Admin.Catalog.Products.List.SearchPublished")]
        public int SearchPublishedId { get; set; }

        [SiteResourceDisplayName("Admin.Catalog.Products.List.GoDirectlyToSku")]
        [AllowHtml]
