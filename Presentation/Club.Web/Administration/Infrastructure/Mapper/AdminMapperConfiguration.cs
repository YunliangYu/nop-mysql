...
using Club.Admin.Models.Topics;
...
using Club.Services.Shipping.Pickup;
using Club.Services.Tax;
using Club.Web.Framework.Security.Captcha;

namespace Club.Admin.Infrastructure.Mapper
{
    /// <summary>
        ...
        public Action<IMapperConfigurationExpression> GetConfiguration()
        {
            ...
            Action<IMapperConfigurationExpression> action = cfg =>
            {
                ...
                cfg.CreateMap<NewsItem, NewsItemModel>()
                    ...
                    .ForMember(dest => dest.EndDate, mo => mo.Ignore())
                    .ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
                    .ForMember(dest => dest.NewsTags, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableStores, mo => mo.Ignore())
                    .ForMember(dest => dest.SelectedStoreIds, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore())
                    .ForMember(dest => dest.PictureThumbnailUrl, mo => mo.Ignore())
                    .ForMember(dest => dest.NewsProgramName, mo => mo.Ignore())
                    .ForMember(dest => dest.AddPictureModel, mo => mo.Ignore())
                ...
                cfg.CreateMap<NewsItemModel, NewsItem>()
                    ...
                    .ForMember(dest => dest.NewsTags, mo => mo.Ignore())
                    .ForMember(dest => dest.Language, mo => mo.Ignore())
                    .ForMember(dest => dest.NewsPictures, mo => mo.Ignore())
                    .ForMember(dest => dest.StartDateUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.EndDateUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.LimitedToStores, mo => mo.Ignore());

                cfg.CreateMap<NewsTag, NewsTagModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<NewsTagModel, NewsTag>();

                cfg.CreateMap<NewsProgram, NewsProgramModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<NewsProgramModel, NewsProgram>();
                //news
